      ...
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          <div className="px-4 my-4 w-full xl:w-1/5">
              ...
              <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fillRule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" fontSize="512" fontWeight="bold">
                      <tspan x="654" y="518">HN Vet</tspan>
                    </text>
                  </g>
                </g>
              </svg>
            ...
            Huynh Nhu Vet Clinic is a ready-to go basis for your site & a theme that’s sure to be your new best friend.
            </p>
          </div>

          <div className="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-blue-600">Useful links</h2>
            </div>
