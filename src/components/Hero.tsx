...
import bgPic from "../../public/images/hero/bg-3.jpg";
...
const images = [
  {
    imageLink: "../../../public/images/hero/hero-img-1.jpg",
  },
];
      ...
      <div className="bg-white">
        ...
        <header className="absolute inset-x-0 top-0 z-50 overflow-hidden">
          ...
          >
            <div className="flex lg:flex-1">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Thú Y Huỳnh Như</span>
                <img
          ...
          >
            ...
            <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-50/10">
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-5xl font-bold tracking-tight text-gray-50 sm:text-6xl">
                Thú Y Huỳnh Như
              </h1>
