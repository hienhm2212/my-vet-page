        ...
        <div className="mt-8 lg:mt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="max-w-full mx-auto rounded-lg overflow-hidden">
                <div className="border-t border-gray-200 px-6 py-4">
                  ...
                  <p className="mt-1 font-bold text-gray-600">
                    <a href="tel:+123">Điện thoại: 0961291597</a>
                  </p>
                  <a className="flex m-2" href="tel:+84961291597">
                ...
                <div className="px-6 py-4">
                  ...
                  <p className="mt-1 text-gray-600">
                    138 Hà Duy Phiên, xã Bình Mỹ, Huyện Củ Chi, TP.HCM
                  </p>
                </div>
                <div className="border-t border-gray-200 px-6 py-4">
            ...
            <div className="rounded-lg overflow-hidden order-none sm:order-first">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3917.3368823366436!2d106.64298817580308!3d10.93790488922081!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d7bb4dc67467%3A0xda49a14bf5d6daf4!2zUGjDsm5nIEtow6FtIFRow7ogWSBIdeG7s25oIE5oxrA!5e0!3m2!1svi!2skr!4v1718044023238!5m2!1svi!2skr"
                width="600"
                height="450"
                style={{ border: 0 }}
